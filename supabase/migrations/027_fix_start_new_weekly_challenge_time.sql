...
declare
    ...
    -- Calculate this week's Saturday 20:00 UTC
    v_this_saturday timestamptz := date_trunc('week', now() at time zone 'utc') + interval '5 days 20 hours';
    -- The weekly cron runs at 20:05 UTC; we still want the challenge to start at 20:00 UTC.
    v_starts_at timestamptz := v_this_saturday;
    v_ends_at timestamptz := v_starts_at + interval '7 days'; -- Next Saturday 20:00 UTC
