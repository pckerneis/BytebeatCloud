  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content={`Bytebeats tagged #${titleTag} on BytebeatCloud`} />
        <meta property="og:image" content={`${typeof window !== 'undefined' ? window.location.origin : ''}/api/og/tag/${encodeURIComponent(titleTag)}`} />
